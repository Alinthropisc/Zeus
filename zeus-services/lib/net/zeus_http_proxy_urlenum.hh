...
// Ported from THC-Hydra's hydra-http_proxy_urlenum.c — original C source not reused,
...
namespace zeus::net
{
    ...
    class ZeusHttpProxyUrlenumModule final : public zeus::proto::ZeusProtocolService
    {
        public:
