...
// Ported from THC-Hydra's hydra-oracle_listener.c — original C source not reused,
...
namespace zeus::database
{
    ...
    class ZeusOracleListenerModule final : public zeus::database::ZeusDatabaseService
    {
        public:
